                                    ...
                                    <table class="table align-middle">
                                        ...
                                        @foreach($cart as $key => $item)
                                            <tr>
                                                <th>
                                                    <img class="rounded"
                                                         src="{{ getImagePath($item['primary_image']) }}"
                                                         width="100" alt=""/>
                                                </th>
                                                ...
                                                <td>
                                                    ...
                                                    @endphp
                                                    <span>{{ number_format( $price * $item['qty'] ) }}</span>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-12 col-md-6 d-flex justify-content-end align-items-baseline">
                                @if ($addresses->isEmpty())
                                    <div>
                                        <a href="{{ route('profile.createAddress') }}" class="btn btn-primary">
                                            ایجاد آدرس
                                        </a>
                                        <div
                                            class="form-text text-danger">@error('address_id') {{$message}} @enderror</div>
                                    </div>
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <ul class="list-group mt-4">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between">
                                                ...
                                                <div>
                                                    @if ($couponPrice != 0)
                                                        {{ number_format($cart_total_price - $couponPrice) }}
                                                    @else
                                        ...
                                        <form action="{{ route('payment.send') }}" method="post">
                                            @csrf
                                            <input name="coupon" value="{{ $couponCode ?? null }}" type="hidden">
