...
@section('pageTitle', 'آدرس ها')

@section('body')
    <div class="col-sm-12 col-lg-9">
        <a href="{{ route('profile.createAddress') }}" class="btn btn-primary mb-4">
            ایجاد آدرس جدید
        </a>
        ...
        @foreach($addresses as $address)
            ...
            <div class="card card-body">
                ...
                <div class="mt-4">
                    <a href="{{ route('profile.editAddress' , ['address' => $address->id]) }}" class="btn btn-primary">ویرایش</a>
                </div>
            </div>
            <hr />
